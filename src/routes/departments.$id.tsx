          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Leader: {dept.leader} • {dept.members} members
              </p>
            </div>
          </div>
            ...
            <Card className="p-5">
              ...
              <div className="mt-3 space-y-2 text-sm">
                <div className="flex justify-between border-b pb-2">
                  <span>Next rehearsal</span>
                  <span className="font-medium">Thu 7:00 PM</span>
                </div>
                <div className="flex justify-between border-b pb-2">
                  <span>Service rotation</span>
                  <span className="font-medium">Sun 8:00 AM</span>
                </div>
                <div className="flex justify-between">
                  <span>Monthly review</span>
                  <span className="font-medium">Last Fri</span>
                </div>
              </div>
            </Card>
